...
<body class="bg-slate-100">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:block w-1/2 relative">
            ...
            {{-- Decorative blur shapes (matches admin dashboard aesthetic) --}}
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center bg-slate-100 px-6 py-10">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 w-full max-w-md p-8">
                ...
                <p class="text-slate-500 mt-1.5 mb-6 text-sm">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" placeholder="••••••••"
                                class="peer block w-full rounded-xl border bg-slate-50 pl-10 pr-11 py-2.5 text-sm text-slate-900 placeholder-slate-400 transition focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100
                            ...
                            <button type="button" onclick="togglePassword()"
                                ...
                                <svg id="eyeIcon" class="w-4.5 h-4.5" width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <a href="#" class="font-medium text-blue-600 hover:text-blue-700 hover:underline">
                            Lupa password?
                        </a>
                    </div>
                ...
                <p class="mt-6 text-center text-sm text-slate-500">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="font-semibold text-blue-600 hover:text-blue-700 hover:underline">Daftar sekarang</a>
                </p>
            </div>
