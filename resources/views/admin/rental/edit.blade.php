...
@section('content')
    <div class="rounded-[2rem] bg-white p-6 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.2)]">
        ...
        <form action="{{ route('admin.rental.update', $data->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit"
                    class="rounded-full bg-violet-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-violet-700">Update</button>
            </div>
        </form>
    </div>
@endsection
