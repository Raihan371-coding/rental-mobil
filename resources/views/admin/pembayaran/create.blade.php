        ...
        <form action="{{ route('admin.pembayaran.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_bayar" name="tanggal_bayar" value="{{ old('tanggal_bayar') }}"
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit"
                    class="rounded-full bg-emerald-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-emerald-700">Simpan</button>
            </div>
        </form>
    </div>
@endsection
