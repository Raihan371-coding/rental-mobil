...
<div class="rounded-[2rem] bg-white p-6 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.2)]">
    ...
    <form action="{{ route('admin.denda.update', $denda->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('admin.denda.index') }}" class="rounded-full border border-slate-200 bg-white px-5 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50">Batal</a>
