...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-slate-500 mb-3">
        ...
        <span class="text-slate-900 font-medium">Tambah Customer</span>
    </div>
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Tambah Customer</h1>
            <p class="mt-1 text-sm text-slate-500">Tambah data customer baru dengan mudah.</p>
        </div>
...
<div class="rounded-2xl bg-white shadow-sm border border-slate-100 overflow-hidden">
    <div class="border-b border-slate-100 px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h3 class="text-base font-bold text-slate-900">Form Tambah Customer</h3>
                <p class="text-xs text-slate-400">Lengkapi informasi customer di bawah ini</p>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.customer.store') }}" method="POST" class="p-6 space-y-6" id="customerForm">
        @csrf
        <div class="grid gap-6 sm:grid-cols-2">
            <div>
                <label for="nama" class="block text-sm font-semibold text-slate-700">Nama <span class="text-red-500">*</span></label>
            ...
            <div>
                <label for="alamat" class="block text-sm font-semibold text-slate-700">Alamat <span class="text-red-500">*</span></label>
            ...
            <div>
                <label for="no_telp" class="block text-sm font-semibold text-slate-700">No Telepon <span class="text-red-500">*</span></label>
