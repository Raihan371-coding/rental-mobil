...
<div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.2)]">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <a href="{{ route('admin.mobil.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-sky-300 hover:bg-sky-50">
        ...
        <a href="{{ route('admin.service.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-50">
        ...
        <a href="{{ route('admin.booking.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-violet-300 hover:bg-violet-50">
        ...
        <a href="{{ route('admin.pengembalian.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-slate-400 hover:bg-slate-100">
        ...
        <a href="{{ route('admin.pembayaran.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-rose-300 hover:bg-rose-50">
        ...
        <a href="{{ route('admin.rental.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-amber-300 hover:bg-amber-50">
        ...
        <a href="{{ route('admin.denda.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-fuchsia-300 hover:bg-fuchsia-50">
        ...
        <a href="{{ route('admin.customer.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-cyan-300 hover:bg-cyan-50">
        ...
        <a href="{{ route('admin.promo.index') }}" class="group block rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:border-indigo-300 hover:bg-indigo-50">
