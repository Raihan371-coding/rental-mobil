...
@section('content')
    <div class="space-y-6">
        <div class="rounded-lg bg-white p-6 shadow-sm">
            ...
            <p class="mt-2 text-sm text-slate-500">Lihat promo yang sedang berlaku untuk mendapatkan potongan harga rental.
            </p>
        </div>
            ...
            @forelse($promos as $promo)
                <div class="rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-white p-5 shadow-sm">
                    <div class="flex items-center gap-3">
                        <span
                            class="rounded-full bg-indigo-100 px-3 py-1 text-xs font-bold text-indigo-700">{{ $promo->kode_promo }}</span>
                    </div>
                    <p class="mt-3 text-2xl font-bold text-indigo-700">
